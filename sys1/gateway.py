...
from sys1.speculative import SpeculativeEngine
...
class GatewayRequestHandler(BaseHTTPRequestHandler):
    ...
    def initialize(cls, config: GatewayConfig):
        ...
        if config.compiled_instinct is not None:
            ...
            from sys1.compiler import CompiledInstinct
        ...
        if config.distill_buffer is not None:
            ...
            from sys1.distill import DistillationBuffer
        ...
        if config.distill_worker is not None:
            ...
            from sys1.distill import DistillationWorker
        ...
        if config.kv_engine is not None:
            ...
            from sys1.kv import KVCacheEngine, KVConfig
    ...
    def do_POST(self):
        ...
        if norm_path in ("/v1/chat/completions", "/chat/completions"):
            ...
            if self.distill_worker is not None:
                ...
                from sys1.distill import AutonomousDistiller
                ...
                for part in c:
                    if isinstance(part, dict):
                        if part.get("type") == "text":
                            ...
                            if img_url:
                                try:
                                    from sys1.vision import PerceptualHasher
...
class ReflexGatewayServer:
    ...
    def start(self, background: bool = False):
        ...
        if background:
            ...
            print(f"⚡ sys1 AI Envoy Gateway running at http://{self.config.host}:{self.config.port}")
