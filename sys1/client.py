...
from sys1.primitives import PrimitiveType, Noul, Choice, Score, DecisionResult
...
from sys1.learning import SelfTuningInstinctHead
from sys1.feedback import FeedbackCollector
from sys1.mesh import InstinctMeshNode, MeshConfig
from sys1.shadow import DecisionShadowRouter, ShadowConfig, ShadowStage
from sys1.speculative import SpeculativeEngine, SpeculativeSession, SpeculativeAction
...
from sys1.compiler import CompiledInstinct, InstinctCompiler, PromptSpec
from sys1.ensemble import InstinctEnsemble, EnsembleResult
...
class Reflex:
    ...
    def __init__(
        ...
        **backend_kwargs,
        ...
        if isinstance(backend, BaseBackend):
            ...
            from sys1.shm import ReflexIPCClient
    ...
    def visual_noul(
        ...
        """
        from sys1.vision import ZeroDepImageDecoder, PerceptualHasher
    ...
    def align_prompt(
        ...
        from sys1.kv import PromptAligner
